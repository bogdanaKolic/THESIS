This folder contains the STREAM benchmark that we use to create LOAD conditions on our systems. The parameters `STREAM_ARRAY_SIZE` and `NTIMES` are tuned. <br>
## Reference:
