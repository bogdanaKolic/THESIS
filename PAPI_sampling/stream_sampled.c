...
#   define STREAM_ARRAY_SIZE	64000000
#endif
...
#ifndef FILENAME
#define FILENAME "stream_sampled.dat"
#endif // FILENAME
...
void *thread_func(void * args){
    ...
    printf("stream, %lld, %lld, %lld, ", values[0], values[1], values[2]);
...
void timer_handler(int sig){
   ...
   /* Read all counters */
    ...
    /* Print the results */
    // printf("result (%s): %lld\n", EVENT, values[0]);
    fprintf(f, "stream %lf %lld %lld %lld\n", diff, values[0], values[1], values[2]);
