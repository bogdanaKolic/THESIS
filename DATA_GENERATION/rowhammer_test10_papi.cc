...
#ifndef LOAD
#define LOAD 0
#define FILENAME "rh10_" + LAPTOP + ".csv"
#else
#define FILENAME "rh10_load_" + LAPTOP + ".csv"
#endif //LOAD
...
void main_prog() {
  ...
  memset(g_mem, 0xff, mem_size);
    ...
    toggle(70, 10); //iterations, addr_count
