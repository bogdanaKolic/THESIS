...
#ifndef LOAD
#define LOAD 0
#define FILENAME "attack_ntmp_" LAPTOP ".csv"
#else
#define FILENAME "attack_ntmp_load_" LAPTOP ".csv"
#endif //LOAD
...
void *thread_func(void * args){
    ...
    printf("attack_ntmp, %lld %lld %lld %lld\n", values[0], values[1], values[2], values[3]);
