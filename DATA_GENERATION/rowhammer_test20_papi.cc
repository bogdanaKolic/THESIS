...
#ifndef LOAD
#define LOAD 0
#define FILENAME "rh20_" LAPTOP ".csv"
#else
#define FILENAME "rh20_load_" LAPTOP ".csv"
#endif //LOAD
...
void main_prog() {
  ...
  memset(g_mem, 0xff, mem_size);
    ...
    toggle(35, 20); //iterations, addr_count
