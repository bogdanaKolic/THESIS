...
#ifndef LOAD
#define LOAD 0
#define FILENAME "rh9_" LAPTOP ".csv"
#else
#define FILENAME "rh9_load_" LAPTOP ".csv"
#endif //LOAD
...
void main_prog() {
  ...
  memset(g_mem, 0xff, mem_size);
    ...
    toggle(80, 9); //iterations, addr_count
