...
#ifndef LOAD
#define LOAD 0
#define FILENAME "rh4_" + LAPTOP + ".csv"
#else
#define FILENAME "rh4_load_" + LAPTOP + ".csv"
#endif //LOAD
...
void main_prog() {
  ...
  toggle(150, 4); //iterations, addr_count
